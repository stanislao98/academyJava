...
public class Stringhe {
	public static void main (String[] args) {
		...
		/*
		 * String, con chiamata ad un costruttore. Di default è una stringa vuota.
		 */
		...
		String stringsVuota = "";
		//la stringa vuota è spesso chiamata blank
		
		String stringaDaIntero = String.valueOf(100); 
		/* metodo statico poichè nomeClasse.nomeMetodo
		...
		// nomeIstanza.nomeMetodo() è una chiamata  a un metodo di istanza
