...
public class EserciziStringheEIf {
	/*
	 * ogni esercizio è un metodo differente che poi chiameremo da un main per testare 
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println("Il massimo è: " + maxInt(1,8));
	...
	public static void printIndex(String string) { 
		if (containsIgnoreCase(string, "a")) {
			System.out.println("L'indice della a all'interno di " + string + " è: " + string.indexOf("a"));
		} else 
			System.out.println("La stringa " + string + "non contiene la lettera a");
		
	}
	//5) fornite in ingresso due stringhe, restituire la più lunga
